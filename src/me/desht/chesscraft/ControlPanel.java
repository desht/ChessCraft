...
public class ControlPanel {
	...
	void repaintSignButtons() {
		...
		createSignButton(2, 2, "invite-player",	";Invite;Player", eastFacingWallSign, settingUp && (!hasWhite || !hasBlack));
		createSignButton(3, 2, "invite-anyone",	";Invite;ANYONE", eastFacingWallSign, settingUp && (!hasWhite || !hasBlack));
		...
		createSignButton(1, 1, "white-promote", "White Pawn;Promotion;;" + getPromoStr(game, Chess.WHITE), eastFacingWallSign, hasWhite);
		createSignButton(6, 1, "black-promote", "Black Pawn;Promotion;;" + getPromoStr(game, Chess.BLACK), eastFacingWallSign, hasBlack);
	...
	void signClicked(Player player, Block block, BoardView view) throws ChessException {
		...
		if (button == null) {
//			plugin.log(Level.WARNING, "Can't find button at location " + block.getLocation());
			return;
		}
